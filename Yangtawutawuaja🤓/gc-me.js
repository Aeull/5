...
runtime = process.uptime()
	 ...
	 message: { "liveLocationMessage": { "caption":"SC : https://github.com/RaaaGH","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./src/logo.jpg')}}
	}

					//m.reply(teks)
					let jawab = `\n\nhttps://chat.whatsapp.com/Gx5XhVZh3IkHGMcQZThcrf\n\n`.trim()
